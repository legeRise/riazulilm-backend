...
class R2Storage:
    def __init__(
        ...
        print(os.getenv("R2_ACCESS_KEY_ID"),'is the access key')
        print(os.getenv("R2_SECRET_ACCESS_KEY"),'is the secret key')
        print(self.endpoint,'is the endpoint')
    ...
    def get_view_url(self, key, expires_in=3600, public=False):
        if public:
    ...
    def upload_file(self, key, file_path, content_type=None, public=False):
        extra = {}
        if public:
        ...
        return self.get_view_url(key, public=public)
...
if __name__ == '__main__':
    r2_bucket = R2Storage(bucket_name='riazulilm-static')
    print(r2_bucket.list_files())
